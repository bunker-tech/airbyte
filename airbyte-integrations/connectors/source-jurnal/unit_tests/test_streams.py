...
import pytest
from source_jurnal.source import JurnalStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JurnalStream, "path", "v0/example_endpoint")
    mocker.patch.object(JurnalStream, "primary_key", "test_primary_key")
    mocker.patch.object(JurnalStream, "__abstractmethods__", set())
