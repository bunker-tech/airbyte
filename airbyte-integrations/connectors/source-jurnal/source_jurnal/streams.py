...
class JurnalStream(HttpStream, ABC):
    ...
    primary_key = None
    single_or_many = SingleOrMany.MANY
    ...
    def parse_response(self, response: requests.Response, **kwargs) -> Iterable[Mapping]:
        ...
        records = [response_records] if self.single_or_many == SingleOrMany.SINGLE else response_records
...
class CurrentActiveCompany(JurnalStream):
    ...
    primary_key = "id"
    single_or_many = SingleOrMany.SINGLE
